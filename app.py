...
def plan_step(state: AgentState, model: genai.GenerativeModel) -> Dict[str, any]:
    ...
    try:
        ...
        return {"plan": plan, "current_task_index": 0, "revision_number": 0, "reflection": ""} 
...
def reflect_step(state: AgentState, model: genai.GenerativeModel) -> Dict[str, any]:
    ...
    full_plan_str = format_plan(plan) 
    ...
    try:
        ...
        prompt = PROMPTS["REFLECTOR"].format(
            ...
            next_task_index_display=next_task_index + 1 
        )
        ...
        if reflection_output.upper() == "DONE":
            ...
            if new_plan_tasks:
                ...
                st.markdown(format_plan(revised_full_plan)) 
                ...
                return {
                    ...
                    "current_task_index": new_current_task_index, 
...
def main():
    ...
    st.session_state.max_rev_input = st.number_input(
        ...
        min_value=0,
        max_value=10,
        value=st.session_state.max_rev_input, 
    ...
    if st.button("Run Pipeline", key="run_button"):
        ...
        workflow.add_conditional_edges(
            ...
            should_continue, 
            {
                "continue_execution": EXECUTOR_NODE, 
                "end": END 
            }
        )
